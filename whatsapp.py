                ...
                "sections": [
                    {
                        "title": "Attachments",
                        "rows": [
                            {"id": LIST_ATTACH_PREVIEW, "title": "👀 Preview/List attachments"},
                            {"id": LIST_ATTACH_REMOVE_LAST, "title": "🗑️ Remove last attachment"},
                            {"id": LIST_ATTACH_CLEAR_ALL, "title": "🧹 Clear all attachments"},
                        ],
                    }
                ],
            },
